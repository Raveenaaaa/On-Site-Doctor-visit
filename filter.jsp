...
Connection conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/users?useSSL=false","root","root@1234");
	...
	ResultSet rs1=s.executeQuery("select dr_name,dr_timings.mob_no from dr_details,dr_timings,location_details,edu_info where dr_details.mob_no=dr_timings.mob_no and dr_timings.mob_no=location_details.mob_no and location_details.mob_no=edu_info.mob_no and dr_timings.fees<='"+fees1+"' and location_details.address='"+area1+"' and dr_details.gender='"+gender1+"' and speciality='"+id+"';");
	int i=0;
