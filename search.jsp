...
Connection conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/users?useSSL=false","root","root@1234");
	...
	ResultSet rs1=s.executeQuery("select dr_name,dr_timings.mob_no from dr_details,dr_timings,location_details where dr_details.mob_no=dr_timings.mob_no and dr_timings.mob_no=location_details.mob_no and dr_timings.fees<='"+fees1+"' and location_details.address='"+area1+"' and dr_details.gender='"+gender1+"';");
	int i=0;
...
<br>
 ...
 <center>
   ...
   <center>
		...
		<%int num=rs1.getInt(2); System.out.println(num);%>
        <a href="DocInfoBooking.jsp?Id= <%=rs1.getInt(2)%>" class="btn bgcolor"><span class="textcolor">View Profile</span> </a>
        </div>
	</center>	  
...
ResultSet rs2=s.executeQuery("select dr_name,dr_timings.mob_no from dr_details,dr_timings,location_details,edu_info where dr_details.mob_no=dr_timings.mob_no and dr_timings.mob_no=location_details.mob_no and location_details.mob_no=edu_info.mob_no and speciality='"+id+"';" );
...
<section >
        ...
        <form action="search.jsp" method="post" >
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12 p-0">
                            <select class="form-control search-slt" name="gender" id="exampleFormControlSelect1">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12 p-0">
                            <select class="form-control search-slt" name="fees" id="exampleFormControlSelect1">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12 p-0">
                            <select class="form-control search-slt" name="area" id="exampleFormControlSelect1">
                                <option value="">Select Your Area </option> 
								<option value="swargate">swargate</option>
								<option value="vimannagar">Viman nagar</option>
